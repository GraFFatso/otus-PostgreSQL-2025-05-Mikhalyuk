...
...
```
* в pgadmin добавил подключения к запущенным кластерам с правильными портами, смог подключиться к каждому из кластеров, увидел созданные в каждом из кластеров СУБД